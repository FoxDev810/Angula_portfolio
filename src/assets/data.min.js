const identity = { name: "Hito Yamaitachi", image: "Profile-pic" };
const data = {
	NavBar: {
		...identity,
		links: [
	...
	Home: {
		introduction:
			// "I am a 2022 pass out student of Bachelor of Technology in Computer Science Engineering from Jaypee Institute Of Information Technology, Sector 62",
            "Coding World is a Beatiful World as well as Real Visual world. I love code & life",

		resumeLink: "1plLnPRjzXrrqQzrrrU8mqAU5suiGrSul",
		typedElement: [
			"Hito Yamaitachi",
			"Laravel/Vue3 Developer",
			"Figma Designer",
			"Flutter Expert",
            "Wordpress, Shopify Developer",
            "API Expert",
			"MEAN/MERN/MEVN Stack Developer",
			"Android Developer",
	...
	About: {
		...
		about: {
			"tech-stats":
				"Full Stack Web Developer, Android, Flutter, WordPress, Shopify, Blockchain Developer, Data Science And DevOps Enthusiast",
			bio: "An Enthusiast Coder Eager to contribute to team success through hard work, skills, attention to details and excellent organizational skills. Currently, Exploring the world of Technology as an Associate Software Development Engineer - 2 at Publicis Sapient. Formerly worked as a Data Science Intern at Talent Decrypt for 9 months and Android Developer at Theatron for 8 months.",
			"IDE, Editors & Tools": [
				"Android Studio",
				"Intellij",
				"PyCharm",
		...
		skills: [
			[
				...
				{ skill: "MEAN/MERN/MEVN Stack Development", progress: "85" },
                { skill: "Laravel/Vue Stack Development", progress: "93" },
                { skill: "Figma Design", progress: "90" },
			],
			[
				{ skill: "Flutter/Dart", progress: "95" },
				{ skill: "C++", progress: "90" },
				{ skill: "Python/Django", progress: "95" },
				{ skill: "HTML/CSS", progress: "90" },
				{ skill: "Javascript/JQuery", progress: "90" },
				{ skill: "Git/GitHub", progress: "95" },
                { skill: "Blockchain/Smart Contract", progress: "83" },
				{ skill: "DevOps", progress: "80" },
                { skill: "Shopify Wordpress", progress: "80" },
			],
		],
		education: [
			{
			...
			},
            {
                ...
                college: "Osaka Prefectural Sakai High School of Science and Technology",
	...
	Portfolio: [
		{
            ...
            project: "Food-Store",
			description:
				// "AI Image Caption Bot is a special project which uses almost every topic of data science and Machine Learning. In this project, we can upload image and bot will predict the caption of that image.",
                "Roasted Revolution Website is  a Canadian company that focuses on providing high-quality, ethically sourced coffee. In this project, I implemented API Integration with Instagram to feed gallery for product cards",
			placement: "top",
		},
		{
			...
			description:
				"In this project we were able to generates melodious sound of piano by mixing different nodes and chords By training on LSTM Model.",
			placement: "top",
		},
		{
			animationClass: "rotateInDownRight",
			delay: "0.5s",
			project: "Tradelog-Flutter",
			description:
				// "Using School Donation Datasets,I was able to Analysed and Visualized using numPy and pandas & Plotly, Cufflinks and Matplotlib respectively.",
                "Tradelog-Flutter is Flutter project, as backend used serverpod, and as database used Firebase",
			placement: "top",
		},
		{
			animationClass: "rotateInUpLeft",
			delay: "0.5s",
			project: "LinFaung-Portfolio",
			description:
				// " A Social Media Is an application developed with MEAN Stack Development. In this application, you can make friends ,besties and enemy, allow user to share their thoughts as post and can chat through one-to-one messages.",
                "LinFaung is working as a freelancer in Workana, I built this project with Laravel/Vue3 Stack, and used tailwindcss, scrollify for theme. Every section transition is all scrollify",
			placement: "bottom",
		},
		{
			...
			description:
				"Created An E-Commerce Site using Reactjs, REDUX, HTML, CSS and JavaScript where a user can buy product, add it to cart and added PayPal Button to make payment.",
			placement: "bottom",
		},
		{
			...
			description:
				"Created An Web Application which help us to shorten the URL by using Firebase Firestore as Database and Bootstrap for Front end.",
			placement: "bottom",
		},
	],
	Training: {
	...
	Contact: [
		...
		},
		{
			...
			links: [
				// { type: "tel:", title: "+91-8377838183" },
				{ type: "tel:", title: "+44-7399225607" },
			],
		},
		{
			animationClass: "Right",
			...
			links: [{ type: "mailto:", title: "hitoyamaitachi@gmail.com" }],
		},
	],
	Social: [
		[
			{
				link: "https://github.com/Hito Yamaitachi",
				class: "fab fa-github",
				name: "GitHub",
				placement: "left",
			},
			{
				link: "https://www.linkedin.com/in/goldentower0559",
				class: "fab fa-linkedin-in",
				name: "LinkedIn",
				placement: "top",
			},
            // {
			// 	link: "https://t.me.takuya_senior",
			// 	class: "fab fa-telegram",
			// 	name: "Telegram",
			// 	placement: "top",
			// },
			// {
			// 	link: "https://gist.github.com/Hito Yamaitachi",
			// 	class: "fas fa-laptop-code",
			// 	name: "Gist",
			// 	placement: "top",
			// },
			// {
			// 	link: "https://www.hackerrank.com/hitoyamaitachi",
